package com.cokiri.coinkiri.presentation.screens.price.component
...
fun CommentCard(
    ...
    val level = coinTalk.member.level
    val name = coinTalk.member.nickname
    val data = coinTalk.createdAt
    val content = coinTalk.content
    val profileImageByteArray = coinTalk.member.pic
